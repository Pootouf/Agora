...
final class Version20231222140952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card_six_qp (id INT AUTO_INCREMENT NOT NULL, help_id INT DEFAULT NULL, value INT NOT NULL, points INT NOT NULL, UNIQUE INDEX UNIQ_752340F1D3F165E7 (help_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
