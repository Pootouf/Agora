...
final class Version20240213214023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE development_cards_spl (id INT AUTO_INCREMENT NOT NULL, help_id INT DEFAULT NULL, value INT NOT NULL, prestige_points INT NOT NULL, color VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EBA2C637D3F165E7 (help_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
