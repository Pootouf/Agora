...
/* platform/game/game.html.twig */
class __TwigTemplate_e1c220694037f6e7cd0e64b8f2d28567 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "platform/game/game.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "platform/game/game.html.twig"));

        $this->parent = $this->loadTemplate("platform/base.html.twig", "platform/game/game.html.twig", 1);
...
\t\t\t\t\t<h1 class=\"text-4xl tracking-tight text-gray-900 sm:text-6xl\">Lorem ipsum lorem ipsum</h1>
...
\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 38
            echo "\t\t\t\t\t\t\t<div class=\"relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80 transform transition-transform duration-300 ease-in-out hover:scale-105\">
\t\t\t\t\t\t\t\t<div class=\"absolute top-4 right-4\">
    <button type=\"button\" class=\"star-button bg-white text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500\">
        <svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" class=\"star-icon w-6 h-6\">
...
\t\t</div>
\t</div>
</div></div><div class=\"absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]\" aria-hidden=\"true\">
<div class=\"relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-primary to-danger opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]\" style=\"clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%);\"></div></div></div>
<script>
        // Sélectionnez tous les boutons d'étoile
        ...
        starButtons.forEach(button => {
            ...
            button.addEventListener('click', function() {
                // Sélectionnez l'icône d'étoile associée à ce bouton
                const starIcon = button.querySelector('.star-icon');

                // Vérifiez si l'étoile est jaune
                if (starIcon.style.fill === 'yellow') {
                    // Si oui, changez la couleur en blanc
                    starIcon.style.fill = 'none';
                } else {
                    // Sinon, changez la couleur en jaune
...
";
    ...
    {
        return "platform/game/game.html.twig";
    }
    ...
    {
        return array (  164 => 67,  130 => 38,  126 => 37,  114 => 27,  108 => 23,  106 => 22,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "platform/game/game.html.twig", "C:\\Users\\Cheetoh\\Desktop\\agora\\templates\\platform\\game\\game.html.twig");
    }
}
