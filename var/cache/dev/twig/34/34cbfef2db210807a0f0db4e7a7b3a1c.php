...
class __TwigTemplate_7341b5095f467ab788fa1de2a5b4f92a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<a href=\"#\" class=\"rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600\">Create an account</a>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t</div>
{% endblock %}
", "home/index.html.twig", "C:\\Users\\Cheetoh\\Desktop\\agora\\templates\\home\\index.html.twig");
    }
}
