 ...
 */
class getPawnRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\DTO\PawnRepository' shared autowired service.
     *
     * @return \App\Repository\Game\DTO\PawnRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'DTO'.\DIRECTORY_SEPARATOR.'PawnRepository.php';

        return $container->privates['App\\Repository\\Game\\DTO\\PawnRepository'] = new \App\Repository\Game\DTO\PawnRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
