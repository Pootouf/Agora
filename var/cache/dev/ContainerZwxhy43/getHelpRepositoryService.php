...
{
    /**
     * Gets the private 'App\Repository\Game\HelpRepository' shared autowired service.
     *
     * @return \App\Repository\Game\HelpRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'HelpRepository.php';

        return $container->privates['App\\Repository\\Game\\HelpRepository'] = new \App\Repository\Game\HelpRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
