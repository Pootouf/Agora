 ...
 */
class getGameSixQPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\SixQP\GameSixQPRepository' shared autowired service.
     *
     * @return \App\Repository\Game\SixQP\GameSixQPRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'SixQP'.\DIRECTORY_SEPARATOR.'GameSixQPRepository.php';

        return $container->privates['App\\Repository\\Game\\SixQP\\GameSixQPRepository'] = new \App\Repository\Game\SixQP\GameSixQPRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
