 ...
 */
class getCardSixQPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\SixQP\CardSixQPRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'SixQP'.\DIRECTORY_SEPARATOR.'CardSixQPRepository.php';

        return $container->privates['App\\Repository\\Game\\SixQP\\CardSixQPRepository'] = new \App\Repository\Game\SixQP\CardSixQPRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
