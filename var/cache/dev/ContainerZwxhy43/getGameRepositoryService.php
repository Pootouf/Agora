...
{
    /**
     * Gets the private 'App\Repository\Platform\GameRepository' shared autowired service.
     *
     * @return \App\Repository\Platform\GameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Platform'.\DIRECTORY_SEPARATOR.'GameRepository.php';

        return $container->privates['App\\Repository\\Platform\\GameRepository'] = new \App\Repository\Platform\GameRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
