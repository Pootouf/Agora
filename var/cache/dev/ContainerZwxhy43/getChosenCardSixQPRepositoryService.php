 ...
 */
class getChosenCardSixQPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\SixQP\ChosenCardSixQPRepository' shared autowired service.
     *
     * @return \App\Repository\Game\SixQP\ChosenCardSixQPRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'SixQP'.\DIRECTORY_SEPARATOR.'ChosenCardSixQPRepository.php';

        return $container->privates['App\\Repository\\Game\\SixQP\\ChosenCardSixQPRepository'] = new \App\Repository\Game\SixQP\ChosenCardSixQPRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
