 ...
 */
class getDrawCardsSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\DrawCardsSPLRepository' shared autowired service.
     *
     * @return \App\Repository\Game\Splendor\DrawCardsSPLRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'DrawCardsSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\DrawCardsSPLRepository'] = new \App\Repository\Game\Splendor\DrawCardsSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
