 ...
 */
class getPersonalBoardSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\PersonalBoardSPLRepository' shared autowired service.
     *
     * @return \App\Repository\Game\Splendor\PersonalBoardSPLRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'PersonalBoardSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\PersonalBoardSPLRepository'] = new \App\Repository\Game\Splendor\PersonalBoardSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
