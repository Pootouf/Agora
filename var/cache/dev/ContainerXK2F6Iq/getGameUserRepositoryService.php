 ...
 */
class getGameUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\GameUserRepository' shared autowired service.
     *
     * @return \App\Repository\Game\GameUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'GameUserRepository.php';

        return $container->privates['App\\Repository\\Game\\GameUserRepository'] = new \App\Repository\Game\GameUserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
