 ...
 */
class getPlayerCardSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\PlayerCardSPLRepository' shared autowired service.
     *
     * @return \App\Repository\Game\Splendor\PlayerCardSPLRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'PlayerCardSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\PlayerCardSPLRepository'] = new \App\Repository\Game\Splendor\PlayerCardSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
