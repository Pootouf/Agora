 ...
 */
class getSelectedTokenSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\SelectedTokenSPLRepository' shared autowired service.
     *
     * @return \App\Repository\Game\Splendor\SelectedTokenSPLRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'SelectedTokenSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\SelectedTokenSPLRepository'] = new \App\Repository\Game\Splendor\SelectedTokenSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
