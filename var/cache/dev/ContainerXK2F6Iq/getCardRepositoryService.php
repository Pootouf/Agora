...
{
    /**
     * Gets the private 'App\Repository\Game\DTO\CardRepository' shared autowired service.
     *
     * @return \App\Repository\Game\DTO\CardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'DTO'.\DIRECTORY_SEPARATOR.'CardRepository.php';

        return $container->privates['App\\Repository\\Game\\DTO\\CardRepository'] = new \App\Repository\Game\DTO\CardRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
