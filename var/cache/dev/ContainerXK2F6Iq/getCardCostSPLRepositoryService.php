 ...
 */
class getCardCostSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\CardCostSPLRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'CardCostSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\CardCostSPLRepository'] = new \App\Repository\Game\Splendor\CardCostSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
