 ...
 */
class getTokenSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\TokenSPLRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'TokenSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\TokenSPLRepository'] = new \App\Repository\Game\Splendor\TokenSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
