 ...
 */
class getNobleTileSPLRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Game\Splendor\NobleTileSPLRepository' shared autowired service.
     *
     * @return \App\Repository\Game\Splendor\NobleTileSPLRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'Splendor'.\DIRECTORY_SEPARATOR.'NobleTileSPLRepository.php';

        return $container->privates['App\\Repository\\Game\\Splendor\\NobleTileSPLRepository'] = new \App\Repository\Game\Splendor\NobleTileSPLRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
