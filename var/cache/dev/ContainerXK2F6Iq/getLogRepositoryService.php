...
{
    /**
     * Gets the private 'App\Repository\Game\LogRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Game'.\DIRECTORY_SEPARATOR.'LogRepository.php';

        return $container->privates['App\\Repository\\Game\\LogRepository'] = new \App\Repository\Game\LogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
