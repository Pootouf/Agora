...
{
    /**
     * Gets the private 'App\Repository\Platform\UserRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Platform'.\DIRECTORY_SEPARATOR.'UserRepository.php';

        return $container->privates['App\\Repository\\Platform\\UserRepository'] = new \App\Repository\Platform\UserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
