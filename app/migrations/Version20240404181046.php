 ...
 */
final class Version20240404181046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE private_message (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recepient_id INT NOT NULL, content LONGTEXT NOT NULL, message_time DATETIME NOT NULL, INDEX IDX_4744FC9BF624B39D (sender_id), INDEX IDX_4744FC9BF1B7C6C (recepient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
