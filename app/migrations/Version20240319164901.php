...
final class Version20240319164901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE main_board_myr (id INT AUTO_INCREMENT NOT NULL, help_id INT DEFAULT NULL, actual_season_id INT NOT NULL, game_id INT NOT NULL, year_num INT NOT NULL, UNIQUE INDEX UNIQ_29EF0707D3F165E7 (help_id), UNIQUE INDEX UNIQ_29EF070775266732 (actual_season_id), UNIQUE INDEX UNIQ_29EF0707E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
