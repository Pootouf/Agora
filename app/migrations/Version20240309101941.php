...
final class Version20240309101941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE created_resource (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, personal_board_glm_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_23687AA189329D25 (resource_id), INDEX IDX_23687AA1E216B924 (personal_board_glm_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE created_resource ADD CONSTRAINT FK_23687AA189329D25 FOREIGN KEY (resource_id) REFERENCES resource_glm (id)');
        $this->addSql('ALTER TABLE created_resource ADD CONSTRAINT FK_23687AA1E216B924 FOREIGN KEY (personal_board_glm_id) REFERENCES personal_board_glm (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE created_resource DROP FOREIGN KEY FK_23687AA189329D25');
        $this->addSql('ALTER TABLE created_resource DROP FOREIGN KEY FK_23687AA1E216B924');
        $this->addSql('DROP TABLE created_resource');
