...
class TileGLMServiceIntegrationTest extends KernelTestCase
{
    ...
    public function testActivateTileWhenTileNotOfTypeFairAndNeedNoResources() : void
    {
        // GIVEN
        $entityManager = static::getContainer()->get(EntityManagerInterface::class);
        $tileGLMService = static ::getContainer()->get(TileGLMService::class);
    ...
    public function testActivateTileWhenTileNotOfTypeFairAndNeedResources() : void
    {
        // GIVEN
        $entityManager = static::getContainer()->get(EntityManagerInterface::class);
        $tileGLMService = static ::getContainer()->get(TileGLMService::class);
