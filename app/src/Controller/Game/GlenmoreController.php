...
class GlenmoreController extends AbstractController
{
    ...
    #[Route(
        'game/glenmore/{idGame}/display/propertyCards/{idPlayer}',
    ...
    public function displayPropertyCards(
        ...
        #[MapEntity(id: 'idPlayer')] PlayerGLM $playerGLM
    ): Response {
    ...
    #[Route(
        'game/glenmore/{idGame}/select/money/warehouse/production/mainBoard/{idResourceLine}',
    ...
    #[Route(
        'game/glenmore/{idGame}/select/resource/warehouse/production/mainBoard/{idResourceLine}',
    ...
    #[Route(
        'game/glenmore/{idGame}/buy/resource/warehouse/production/mainBoard/{idResourceLine}',
    ...
    public function buyResourceWarehouseProductionOnMainBoard(
        ...
        try {
            ...
            $this->publishNotification(
                $game,
                GlenmoreParameters::NOTIFICATION_DURATION,
                GlenmoreTranslation::WARNING,
                GlenmoreTranslation::CANNOT_BUY_RESOURCE,
    ...
    #[Route(
        'game/glenmore/{idGame}/activate/selling/resource/warehouse/production/mainBoard/{idResourceLine}',
    ...
    public function activateSellingResourceWarehouseProductionOnMainBoard(
        ...
        if ($player->isActivatedResourceSelection()) {
            ...
            return new Response(
                GlenmoreTranslation::RESPONSE_TRY_SELL_RESOURCE_ALREADY_IN_SELECTION,
                Response::HTTP_FORBIDDEN
            );
        }
    ...
    #[Route(
        'game/glenmore/{idGame}/select/tile/mainBoard/{idTile}',
    ...
    #[Route(
        'game/glenmore/{idGame}/select/tile/mainBoard/{coordX}/{coordY}',
    ...
    public function putTileOnPersonalBoard(
        ...
        if($player->isActivatedResourceSelection()) {
            ...
            return new Response(
                GlenmoreTranslation::RESPONSE_TRY_PLACE_TILE_IN_RESOURCE_SELECTION,
                Response::HTTP_FORBIDDEN
            );
        }
        try {
            ...
            return new Response(
                GlenmoreTranslation::RESPONSE_NOT_ABLE_TO_PLACE_TILE . $e,
                Response::HTTP_FORBIDDEN
            );
        }
    ...
    #[Route(
        'game/glenmore/{idGame}/select/tile/personalBoard/{idTile}',
    ...
    #[Route(
        'game/glenmore/{idGame}/select/{idTile}/resource/{idPlayerTileResource}',
    ...
    #[Route(
        'game/glenmore/{idGame}/select/leader',
    ...
    #[Route(
        'game/glenmore/{idGame}/select/{idTile}/resource/acquisition/{resource}',
    ...
    public function selectNewResourceAcquisition(
        ...
        if($tile->getTile()->getName() === GlenmoreParameters::CARD_LOCH_LOCHY) {
            try {
                ...
                return new Response(
                    GlenmoreTranslation::RESPONSE_CANNOT_SELECT_MORE_RESOURCE,
                    Response::HTTP_FORBIDDEN
                );
            }
    ...
    #[Route(
        'game/glenmore/{idGame}/remove/{idTile}/villager/{idPlayerTileResource}',
    ...
    public function removeVillager(
        ...
        try {
            ...
            return new Response(
                GlenmoreTranslation::RESPONSE_INVALID_MOVE . $e->getMessage(),
                Response::HTTP_FORBIDDEN
            );
        }
        $this->publishNotification(
    ...
    public function activateTile(
        ...
        if(!$this->tileGLMService->hasActivationCost($tile)) {
            ...
            try {
                ...
                return new Response(
                    GlenmoreTranslation::RESPONSE_CANNOT_ACTIVATE_TILE
                    . $e->getMessage(),
                    Response::HTTP_FORBIDDEN
                );
            }
        ...
        return new Response(
            GlenmoreTranslation::RESPONSE_TILE_ACTIVATED,
            Response::HTTP_OK
        );
    }
    ...
    #[Route(
        'game/glenmore/{idGame}/move/{idTile}/villager/direction/{dir}',
    ...
    public function moveVillager(
        ...
        return new Response(
            GlenmoreTranslation::RESPONSE_MOVE_VILLAGER,
            Response::HTTP_OK
        );
    }

    #[Route(
        'game/glenmore/{idGame}/validate/{idTile}/resource/acquisition',
    ...
    #[Route(
        'game/glenmore/{idGame}/cancel/{idTile}/resource/acquisition',
    ...
    public function cancelNewResourcesAcquisition(
        ...
        return new Response(
            GlenmoreTranslation::RESPONSE_CANCEL_SELECTION,
            Response::HTTP_OK
        );
    }

    #[Route(
        'game/glenmore/{idGame}/validate/resources/selection',
    ...
    public function validateResourcesSelection(
        ...
        if ($playerPhase == GlenmoreParameters::BUYING_PHASE) {
            ...
            try {
                ...
                $this->logService->sendPlayerLog($game, $player, $message);
                return new Response(
                    GlenmoreTranslation::RESPONSE_CANNOT_SELL_RESOURCE,
                    Response::HTTP_FORBIDDEN
                );
            }
        ...
        return new Response(
            GlenmoreTranslation::RESPONSE_VALIDATE_RESOURCES_SELECTION,
            Response::HTTP_OK
        );
    }

    #[Route(
        'game/glenmore/{idGame}/cancel/resources/selection',
    ...
    public function endPlayerRound(
        ...
        return new Response(
            GlenmoreTranslation::RESPONSE_END_ROUND,
            Response::HTTP_OK
        );
    }
    ...
    #[Route(
        'game/glenmore/{idGame}/displayPersonalBoard/{idPlayer}',
    ...
    public function showMainBoard(
        ...
        $player = $this->service->getPlayerFromNameAndGame($game, $this->getUser()->getUsername());
        return $this->render(
            'Game/Glenmore/MainBoard/mainBoard.html.twig',
            [
                'game' => $game,
    ...
    private function publishCreateResource(PlayerTileGLM $playerTileGLM): void
    {
        ...
        $response = $this->render(
            'Game/Glenmore/PersonalBoard/selectTile.html.twig',
            [
            'player' => $player,
    ...
    private function publishMainBoardPreview(GameGLM $game): void
    {
        ...
        foreach ($players as $player) {
            $response = $this->render(
                'Game/Glenmore/MainBoard/preview.html.twig',
                [
                    'game' => $game,
                    'player' => $this->service->getActivePlayer($game),
                    'boardTiles' => $this->dataManagementGLMService->organizeMainBoardRows(
        ...
        foreach($game->getPlayers() as $player) {
            ...
            $this->publishService->publish(
                $this->generateUrl(
                    'app_game_show_glm',
                    ['id' => $player->getGameGLM()->getId()]
                ).'personalBoardSpectator'.$player->getId(),
                $response
            );
        }
    }
        ...
        foreach ($game->getPlayers() as $player) {
            ...
            $this->publishService->publish(
                $this->generateUrl(
                    'app_game_show_glm',
                    ['id' => $game->getId()]
                ).'playerRoundManagement'.$player->getId(),
                $response
            );
        }
    }
    ...
    private function publishMoveVillagerOnPersonalBoard(
        GameGLM $game,
        PlayerGLM $player,
        PlayerTileGLM $originTile,
        PlayerTileGLM $targetedTile
    ): void {
        $this->publishService->publish(
