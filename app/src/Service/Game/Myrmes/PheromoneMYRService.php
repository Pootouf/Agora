...
class PheromoneMYRService
{
     ...
     * @throws Exception
     */
    public function getAllAvailablePositions(PlayerMYR $player,
         TileMYR $tile, TileTypeMYR $tileType) : ArrayCollection
    {
    ...
    {
        $result = "";
        foreach ($pheromone->getPheromonTiles() as $pheromoneTile) {
            $result .= ($pheromoneTile->getTile()->getCoordX()
                . "_" . $pheromoneTile->getTile()->getCoordY() . " ");
        }
        return $result;
    }
    ...
    public function cleanPheromone(PheromonMYR $pheromone, PlayerMYR $player) : void
    {
        ...
        foreach($pheromone->getPheromonTiles() as $pheromoneTile) {
            $this->entityManager->remove($pheromoneTile);
        }
     ...
     * @return PreyMYR|null
     */
    public function getPrey(GameMYR $game, TileMYR $tile) : ?PreyMYR
    {
     ...
     * @return bool
     */
    public function isPositionAvailable(GameMYR $gameMYR, TileMYR $tileMYR) : bool
    {
        ...
        foreach ($players as $player) {
            ...
            $playerPheromones = $this->pheromoneMYRRepository->findBy(["player" => $player]);
