...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: \App\Entity\Platform\PrivateMessage::class, mappedBy: 'sender', orphanRemoval: true)]
    private Collection $sents;

    #[ORM\OneToMany(targetEntity: \App\Entity\Platform\PrivateMessage::class, mappedBy: 'recepient', orphanRemoval: true)]
   ...
   /**
    ...
    public function addSent(\App\Entity\Platform\PrivateMessage $sent): static
    {
    ...
    public function removeSent(\App\Entity\Platform\PrivateMessage $sent): static
    {
    ...
    public function addRecieved(\App\Entity\Platform\PrivateMessage $recieved): static
    {
    ...
    public function removeRecieved(\App\Entity\Platform\PrivateMessage $recieved): static
    {
