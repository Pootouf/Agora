...
use App\Repository\Game\Glenmore\WarehousePlayerResourceGLMRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: WarehousePlayerResourceGLMRepository::class)]
class WarehousePlayerResourceGLM
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'warehousePlayerResources')]
    #[ORM\JoinColumn(nullable: false)]
