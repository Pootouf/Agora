 ...
 * Puissance4Player
 *
 * @ORM\Table(name="puissance4_player")
 * @ORM\Entity(repositoryClass="AGORA\Game\Puissance4Bundle\Repository\Puissance4PlayerRepository")
 */
class Puissance4Player
{
     ...
     * @var int
     * 
     * @ORM\ManyToOne(targetEntity="AGORA\Game\Puissance4Bundle\Entity\Puissance4Game", cascade={"persist"})
